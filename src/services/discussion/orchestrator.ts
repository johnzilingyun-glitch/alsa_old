...
const DEEP_TOPOLOGY: DiscussionRound[] = [
  ...
  { round: 3, experts: ['Sentiment Analyst', 'Risk Manager'], parallel: true, dependsOn: [2] },
  { round: 4, experts: ['Bull Researcher', 'Bear Researcher'], parallel: true, dependsOn: [3] },
  { round: 5, experts: ['Professional Reviewer', 'Contrarian Strategist'], parallel: true, dependsOn: [4] },
