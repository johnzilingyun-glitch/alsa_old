...
3. **FUNDAMENTAL DATA (CRITICAL)**: 
   - Provide specific fundamental data (e.g., PE, PB, ROE, EPS, Revenue Growth).
   - **MANDATORY SEARCH**: Use Google Search to find the absolute values for **Total Revenue (营收)**, **Net Profit (净利润)**, and **Market Cap (市值)** for the most recent fiscal year or quarter. Do NOT leave these as empty or "-" if they can be found.
